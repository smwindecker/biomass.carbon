...
\begin{figure}[ht]
	\centering
	\scalebox{0.9}
	{\includegraphics[width=\textwidth]{chapters/Chapter3_traits/img/trait_flowchart.png}}
...
\begin{figure}[!ht]
	\centering
	{\includegraphics[width=0.2\textwidth]{chapters/Chapter3_traits/img/tga_method.png}}
